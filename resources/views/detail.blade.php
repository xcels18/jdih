                ...
                <div class="relative z-10 flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2.5 mt-2 pt-4 border-t border-slate-100">
                        @if($regulation->file_path)
                            ...
                            <button onclick="switchDetailTab('isi'); document.getElementById('tab-btn-isi').scrollIntoView({ behavior: 'smooth', block: 'start' });" class="inline-flex items-center justify-center gap-2 bg-secondary hover:bg-secondary/90 text-white text-xs font-bold px-4 py-2.5 rounded-xl hover:opacity-95 transition shadow-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4">
